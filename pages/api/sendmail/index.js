...
export default async (req, res) => {
    if(req.method === 'POST') {
        ...
        const emailHTML = `
        <div style='background-color: #f5f5f5; width: 700px; min-height: 620px; margin: 10px auto; text-align: center;'>
        <h2 style='font-size: 25px; font-weight: 22px; text-align: center; padding-top: 10px; font-family:
        "Courier New", Courier, monospace; padding-top: 20px;'>${message}</h2>
