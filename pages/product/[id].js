                   ...
                   <main className="product__page">
                       ...
                       <div className="product__info">
                           <div className="product__img">
                               <img src={data.image? data.image : data.fullImg.replace('http', 'https') } alt="Product Img" />
                           </div>
                           <div className="product__description">
                               ...
                               <ul>
                                ...
                                <h1>{  data.previousPrice && data.price? (Math.ceil(((Number(data.previousPrice) - Number(data.price)) / Number(data.price)) * 100)) + '% Off' : ''  }</h1>
